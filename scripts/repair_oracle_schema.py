...
REQUIRED_COLUMNS = {
    ...
    "AUDIT_EVENTS": {
        ...
        "TRIGGERING_POLICY_JSON": "CLOB",
        "PREV_EVENT_HASH": "VARCHAR2(64)",
        "EVENT_HASH": "VARCHAR2(64)",
        "EVENT_SIGNATURE": "VARCHAR2(128)",
        "HASH_KEY_ID": "VARCHAR2(64)",
        "REDACTED": "NUMBER(1) DEFAULT 0",
    }
}
